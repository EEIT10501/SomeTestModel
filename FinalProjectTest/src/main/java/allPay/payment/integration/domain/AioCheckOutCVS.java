...
public class AioCheckOutCVS {
	...
	/**
	 * MerchantTradeNo 會員交易編號，該交易編號不可重複
	 */
	private String MerchantTradeNo = "";

	/**
	 * StoreID 會員商店代碼，提供會員填入店家代碼使用
	 */
	private String StoreID = "";

	/**
	 * MerchantTradeDate 會員交易時間
	 */
	...
	/**
	 * ClientBackURL Client端返回會員系統的按鈕連結
	 */
	...
	/**
	 * DeviceSource 裝置來源，由allPay自動判定。
	 */
	private String DeviceSource = "";

	/**
	 * IgnorePayment 隱藏付款方式，設定檔自動帶入
	 */
	private String IgnorePayment = "";

	/**
	 * PlatformID 特約合作平台商代號(由allPay提供)，設定檔自動帶入
	 */
	private String PlatformID = "";

	/**
	 * InvoiceMark 電子發票開立註記，程式自動判斷
	 */
