		...
		if (obj.getInvoiceItemName().contains("|")) {
			...
			if (invCount.find()) {
				...
				if (itemCount != paramCount)
					throw new AllPayException("Count of item info InvoiceItemCount(" + paramCount
			...
			if (invWord.find()) {
				...
				if (itemCount != paramCount)
					throw new AllPayException("Count of item info InvoiceItemWord(" + paramCount
							+ ") not match item count from InvoiceItemName(" + itemCount + ")");
			}
			if (invPrice.find()) {
				...
				if (itemCount != paramCount)
					throw new AllPayException("Count of item info InvoiceItemPrice(" + paramCount
							+ ") not match item count from InvoiceItemName(" + itemCount + ")");
			}
			if (invType.find()) {
				...
				if (itemCount != paramCount)
					throw new AllPayException("Count of item info InvoiceItemTaxType(" + paramCount
							+ ") not match item count from InvoiceItemName(" + itemCount + ")");
			}
